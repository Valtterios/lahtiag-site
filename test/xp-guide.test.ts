...
const kind = (over: Partial<TickKind>): TickKind => ({ id: 1, name: 'Helped at an event', description: null, sort: 1, xp: 100, season_cap: 1, period: 'season', claimable: true, retired_at: null, given: 0, ...over });
...
describe('the XP guide', () => {
  ...
  it('puts it together', () => {
    ...
    expect(text).toContain('📅 Events (2 attended), 💬 Discord (40 messages, 1 h 30 min in voice)');
