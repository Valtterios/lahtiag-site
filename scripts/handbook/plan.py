...
shot('membership-card', '/membership', 'admin', clip='.id-card', pad=10)
shot('membership-actives', '/membership', 'admin', clip={'sel': '#membership .panel-card', 'i': 1}, hl=['text=I want to be an active'], pad=8)
...
shot('event-participants-panel', '/events/3', 'admin', open=['details.admin-panel'], openText=['Participants'], clip='.add-forms', pad=14, hl=['text=Add member', 'text=Add participant'], nums=True)
