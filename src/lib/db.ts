...
export type SettingKey = 'member_role_id' | 'actives_role_id' | 'event_category_id' | 'champion_role_id' | 'champion_holders' | 'announce_channel_id' | 'board_channel_id' | 'digest_sent_at';
